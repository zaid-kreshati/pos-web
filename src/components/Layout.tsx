...
import { LogOut, Wallet, LayoutDashboard, FileText, Users, Settings, Bell, Menu, X, ChevronLeft } from 'lucide-react';
...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/create-invoice', label: 'Invoices', icon: FileText },
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed left-0 top-0 h-full w-64 bg-slate-800 text-white z-50 transform transition-transform duration-300 lg:translate-x-0
      ...
      `}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-slate-700">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-700 hover:text-white transition"
          >
